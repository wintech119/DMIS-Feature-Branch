...
# =============================================================================
# Standalone CLI utility - NOT wired into the Flask app.
# Imports data from MLSS_Warehouse_Operations Excel file into hadr_aid_movement_staging table.
#
# Example usages (run from Replit Shell):
#   python import_mlss_warehouse_staging.py "./data/MLSS Warehouse Operations - November 28, 2025.xlsx" --dry-run
#   python import_mlss_warehouse_staging.py "./data/MLSS Warehouse Operations - November 28, 2025.xlsx" --sql-output mlss_import.sql
#   python import_mlss_warehouse_staging.py "./data/MLSS Warehouse Operations - November 28, 2025.xlsx" --db-url "$DATABASE_URL" --create-by "MLSS_IMPORT"
#
# =============================================================================
"""
MLSS Warehouse Operations Import Script
