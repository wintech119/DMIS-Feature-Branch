...
def inject_active_page():
    """
    Auto-detect active navigation menu item based on request endpoint.
    Maps Flask route endpoints to FeatureRegistry feature IDs.
    """
    ...
    if endpoint:
        endpoint_to_feature = {
            'dashboard.index': 'logistics_dashboard',
            'dashboard.donations_analytics': 'donations_analytics',
            'dashboard.relief_package_analytics': 'relief_package_analytics',
            'dashboard.aid_movement_dashboard': 'aid_movement_dashboard',
            'dashboard.aid_item_movement_detail': 'aid_item_movement_detail',
            'director.dashboard': 'director_dashboard',
            'operations_dashboard.index': 'operations_dashboard',
            'inventory.list_inventory': 'inventory_view',
            'inventory.view_inventory': 'inventory_view',
            'donations.list_donations': 'donation_management',
            'donations.view_donation': 'donation_management',
            'donations.create_donation': 'donation_management',
            'donations.edit_donation': 'donation_management',
            'donations.verify_list': 'donation_verification',
            'donations.verify_donation': 'donation_verification',
            'donation_intake.list_intakes': 'donation_intake_management',
            'donation_intake.create_intake': 'donation_intake_management',
            'donation_intake.edit_intake': 'donation_intake_management',
            'donation_intake.view_intake': 'donation_intake_management',
            'donation_intake.verify_list': 'donation_intake_verification',
            'donation_intake.verify_intake': 'donation_intake_verification',
            'requests.list_requests': 'create_request_on_behalf',
            'requests.create_request': 'create_request_on_behalf',
            'requests.view_request': 'create_request_on_behalf',
            'requests.edit_request': 'create_request_on_behalf',
            'packaging.pending_fulfillment': 'package_preparation',
            'packaging.prepare_package': 'package_preparation',
            'packaging.pending_approval': 'package_preparation',
            'packaging.review_approval': 'package_preparation',
            'packaging.awaiting_dispatch': 'dispatch_awaiting',
            'packaging.dispatch_details': 'dispatch_awaiting',
            'packaging.dispatch_received': 'dispatch_received',
            'packaging.dispatch_received_details': 'dispatch_received',
            'eligibility.pending_list': 'eligibility_review',
            'eligibility.review_request': 'eligibility_review',
            'warehouses.list_warehouses': 'warehouse_management',
            'warehouses.create_warehouse': 'warehouse_management',
            'warehouses.edit_warehouse': 'warehouse_management',
            'items.list_items': 'item_management',
            'items.create_item': 'item_management',
            'items.edit_item': 'item_management',
            'item_categories.list_categories': 'item_category_management',
            'item_categories.create_category': 'item_category_management',
            'item_categories.edit_category': 'item_category_management',
            'uom.list_uom': 'uom_management',
            'events.list_events': 'event_management',
            'events.create_event': 'event_management',
            'events.edit_event': 'event_management',
            'agencies.list_agencies': 'agency_management',
            'agencies.create_agency': 'agency_management',
            'agencies.edit_agency': 'agency_management',
            'donors.list_donors': 'donor_management',
            'donors.create_donor': 'donor_management',
            'donors.edit_donor': 'donor_management',
            'custodians.list_custodians': 'custodian_management',
            'custodians.create_custodian': 'custodian_management',
            'custodians.edit_custodian': 'custodian_management',
            'reports.index': 'reports_main',
            'reports.inventory_summary': 'reports_inventory',
            'reports.donations_summary': 'reports_donations',
            'reports.funds_donations': 'funds_donations_report',
            'user_admin.index': 'user_management',
            'user_admin.create_user': 'user_management',
            'user_admin.edit_user': 'user_management',
            'account_requests.list_requests': 'account_requests',
            'account_requests.review_request': 'account_requests',
            'notifications.index': 'notifications',
        }
        active_page = endpoint_to_feature.get(endpoint, '')
